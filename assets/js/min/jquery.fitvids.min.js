        ...
        return t && $.extend(e, t), this.each(function () {
            ...
            r = r.not("object object"), r = r.not(i), r.each(function (t) {
                ...
                if (!(e.parents(i).length > 0 || "embed" === this.tagName.toLowerCase() && e.parent("object").length || e.parent(".fluid-width-video-wrapper").length)) {
                    ...
                    var r = "object" === this.tagName.toLowerCase() || e.attr("height") && !isNaN(parseInt(e.attr("height"), 10)) ? parseInt(e.attr("height"), 10) : e.height(), a = isNaN(parseInt(e.attr("width"), 10)) ? e.width() : parseInt(e.attr("width"), 10), d = r / a;
                    if (!e.attr("id")) {
                        var o = "fitvid" + t;
                        e.attr("id", o)
                    }
